...
<form action="{{url('/registCompany')}}" method="post" >
    {{csrf_field()}}
    <div class="form-group col-md-8">

    <label for="exampleInputName">Company name</label>
    <input class="form-control" id="companyName" name="companyName"type="text" aria-describedby="nameHelp" placeholder="Enter first name" required>
