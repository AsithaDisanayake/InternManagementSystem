...
@section('content')
    ...
    <div class="container">
        <div class="card card-register mx-auto mt-5">
            ...
            <div class="card-body">
                <form action="{{url('/deleteTask')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="form-group">
                        ...
                        <input class="btn btn-danger" style="margin-top: 10px; float: right" type="submit" value="Delete" name="Delete">
